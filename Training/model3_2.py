...
weights = {
    ...
    'wc1': tf.Variable(tf.truncated_normal([3, 3, 1, 24], stddev=0.1)),
    # 5x5 conv, 128 inputs, 180 outputs
    'wc2': tf.Variable(tf.truncated_normal([3, 3, 24, 48], stddev=0.1)),
    # fully connected, (37//4=10)*(50//4=13)*180 inputs, 1200 outputs
    # 5x5 conv, 128 inputs, 180 outputs
    'wc3': tf.Variable(tf.truncated_normal([3, 3, 48, 96], stddev=0.1)),
    # fully connected, (37//4=10)*(50//4=13)*180 inputs, 1200 outputs
